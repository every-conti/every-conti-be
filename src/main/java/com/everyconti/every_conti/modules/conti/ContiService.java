package com.everyconti.every_conti.modules.conti;
...
import com.everyconti.every_conti.modules.conti.dto.request.CopyContiDto;
import com.everyconti.every_conti.modules.conti.dto.request.CreateContiDto;
import com.everyconti.every_conti.modules.conti.dto.request.SearchContiDto;
import com.everyconti.every_conti.modules.conti.dto.request.UpdateContiDto;
...
import com.everyconti.every_conti.common.exception.types.NotFoundException;
import com.everyconti.every_conti.common.exception.types.custom.LimitExceededException;
...
import com.everyconti.every_conti.modules.conti.dto.response.ContiPropertiesDto;
import com.everyconti.every_conti.modules.conti.dto.response.ContiSimpleDto;
import com.everyconti.every_conti.modules.conti.dto.response.ContiWithSongDto;
import com.everyconti.every_conti.modules.conti.eventlistener.ContiCreatedEvent;
import com.everyconti.every_conti.modules.conti.eventlistener.ContiUpdatedEvent;
...
import static com.everyconti.every_conti.constant.ResponseMessage.notFoundMessage;
import static com.everyconti.every_conti.constant.song.MaxSongsPerConti.MAX_SONGS_PER_CONTI;
...
public class ContiService {
    ...
    public ContiWithSongDto updateConti(String contiIdHashed, UpdateContiDto dto) {
        ...
        Conti forDto = contiRepository.getContiAndContiSongByContiId(contiId);

        return new ContiWithSongDto(forDto, hashIdUtil);
    }

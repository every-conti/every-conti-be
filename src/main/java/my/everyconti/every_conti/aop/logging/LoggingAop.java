package my.everyconti.every_conti.aop.logging;
...
public class LoggingAop {
    ...
    @Before("execution(* my.everyconti.every_conti.modules..*Controller.*(..)) && !target(my.everyconti.every_conti.config.SpringConfig)")
    ...
    @AfterReturning(
            pointcut = "execution(* my.everyconti.every_conti.modules..*Controller.*(..)) && !target(my.everyconti.every_conti.config.SpringConfig)",
            returning = "result"
    )
